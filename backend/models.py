...
class ProcedureCase(Base):
    ...
    parent1_first_name: str | None = Column(String, nullable=True)
    parent1_last_name: str | None = Column(String, nullable=True)
    parent1_email: str | None = Column(String, nullable=True)
    parent2_name: str | None = Column(String, nullable=True)
    parent2_first_name: str | None = Column(String, nullable=True)
    parent2_last_name: str | None = Column(String, nullable=True)
