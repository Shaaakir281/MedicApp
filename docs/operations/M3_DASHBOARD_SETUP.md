...
> Guide d'exploitation. Voir `../README.md` pour le pilotage actif du projet.
...
- Requetes KQL: `M3_KQL_QUERIES.md`

## Ajouter les tuiles KQL au dashboard

1. Ouvrir `medicapp-appinsights` -> `Logs`.
2. Copier/coller une requete de `M3_KQL_QUERIES.md`.
...
- Routine de suivi: `MONITORING_RUNBOOK.md`
